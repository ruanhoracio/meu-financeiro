...
import { Plus, Trash2, TrendingUp, Clock, Target } from 'lucide-react'
...
export default function CofrinhosPage() {
  ...
  const [form, setForm] = useState({ nome: '', icone: '🏆', cor: '#820AD1', valor_alvo: '', descricao: '' })
  ...
  async function saveCofrinho() {
    ...
    if (!error) {
      ...
      setShowModal(false)
      setForm({ nome: '', icone: '🏆', cor: '#820AD1', valor_alvo: '', descricao: '' })
      loadCofrinhos()
    }
  }
  ...
  return (
    <AppLayout>
      <div className="page-header">
        ...
        <button id="btn-novo-cofrinho" className="btn btn-primary" onClick={() => setShowModal(true)}>
          <Plus size={16} />
          Novo Cofrinho
        </button>
      </div>
        ...
        <div className="modal-overlay" onClick={e => { if (e.target === e.currentTarget) setShowModal(false) }}>
          <div className="modal">
            <div className="modal-header">
              <h2 className="modal-title">Novo Cofrinho</h2>
            ...
            <div className="modal-footer">
              ...
              <button id="btn-salvar-cofrinho" className="btn btn-primary" onClick={saveCofrinho} disabled={saving}>{saving ? 'Criando...' : 'Criar Cofrinho'}</button>
            </div>
          </div>
        </div>
      )}
